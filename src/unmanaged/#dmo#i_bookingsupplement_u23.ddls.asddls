@AbapCatalog.sqlViewName: '/DMO/IBOOKSU_U23'
...
define view /DMO/I_BookingSupplement_U23
  as select from /dmo/book_sup_23 as BookingSupplement

  association        to parent /DMO/I_Booking_U23  as _Booking         on  $projection.TravelID  = _Booking.TravelID
                                                                     and $projection.BookingID = _Booking.BookingID

  association [1..1] to /DMO/I_Supplement23     as _Product  on $projection.SupplementID = _Product.SupplementID
  association [1..*] to /DMO/I_Supplement23Text23 as _SupplementText on  $projection.SupplementID = _SupplementText.SupplementID
{
  ...
  key BookingSupplement.booking_supplement_id  as BookingSupplementID,
      ...
      @Consumption.valueHelpDefinition: [{entity: {name: '/DMO/I_SUPPLEMENT23', element: 'SupplementID' },
