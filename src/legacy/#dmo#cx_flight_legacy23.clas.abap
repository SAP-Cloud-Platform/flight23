CLASS /dmo/cx_flight_legacy23 DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      gc_msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_23',

      BEGIN OF agency_unkown,
        msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_23',
    ...
    METHODS constructor
      IMPORTING
        ...
        travel_id             TYPE /dmo/travel_id23 OPTIONAL
        booking_id            TYPE /dmo/booking_id23 OPTIONAL
        booking_supplement_id TYPE /dmo/booking_supplement_id23 OPTIONAL
        agency_id             TYPE /dmo/agency_id23 OPTIONAL
        customer_id           TYPE /dmo/customer_id23 OPTIONAL
        carrier_id            TYPE /dmo/carrier23-carrier_id OPTIONAL
        connection_id         TYPE /dmo/connecti_23-connection_id OPTIONAL
        supplement_id         TYPE /dmo/suppleme_23-supplement_id OPTIONAL
        begin_date            TYPE /dmo/begin_date23 OPTIONAL
        end_date              TYPE /dmo/end_date23 OPTIONAL
        booking_date          TYPE /dmo/booking_date23 OPTIONAL
        flight_date           TYPE /dmo/flight_date23 OPTIONAL
        status                TYPE /dmo/travel_status23 OPTIONAL
        currency_code         TYPE /dmo/currency_code23 OPTIONAL
        uname                 TYPE syuname OPTIONAL.

    DATA: mv_travel_id             TYPE /dmo/travel_id23,
          mv_booking_id            TYPE /dmo/booking_id23,
          mv_booking_supplement_id TYPE /dmo/booking_supplement_id23,
          mv_agency_id             TYPE /dmo/agency_id23,
          mv_customer_id           TYPE /dmo/customer_id23,
          mv_carrier_id            TYPE /dmo/carrier23-carrier_id,
          mv_connection_id         TYPE /dmo/connecti_23-connection_id,
          mv_supplement_id         TYPE /dmo/suppleme_23-supplement_id,
          mv_begin_date            TYPE /dmo/begin_date23,
          mv_end_date              TYPE /dmo/end_date23,
          mv_booking_date          TYPE /dmo/booking_date23,
          mv_flight_date           TYPE /dmo/flight_date23,
          mv_status                TYPE /dmo/travel_status23,
          mv_currency_code         TYPE /dmo/currency_code23,
...
CLASS /dmo/cx_flight_legacy23 IMPLEMENTATION.
