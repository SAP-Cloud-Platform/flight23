...
INTERFACE /dmo/if_flight_legacy23
  PUBLIC.
...
******************************
  ...
  "! Table type of the table /DMO/TRAVEL23
  TYPES tt_travel             TYPE SORTED TABLE OF /dmo/travel23     WITH UNIQUE KEY travel_id.
  "! Table type of the table /DMO/BOOKING23
  TYPES tt_booking            TYPE SORTED TABLE OF /dmo/booking23    WITH UNIQUE KEY travel_id  booking_id.
  "! Table type of the table /DMO/BOOK_SUP_23
  TYPES tt_booking_supplement TYPE SORTED TABLE OF /dmo/book_sup_23 WITH UNIQUE KEY travel_id  booking_id  booking_supplement_id.
  "! Table type of the table /DMO/FLIGHT23
  TYPES tt_flight TYPE STANDARD TABLE OF /dmo/flight23 WITH KEY client carrier_id connection_id flight_date.
...
******************
  ...
  TYPES travel_id TYPE /dmo/travel_id23.
  ...
  TYPES booking_id TYPE /dmo/booking_id23.
  ...
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id23.
...
* IMPORTANT: When you add or remove fields from /DMO/TRAVEL23, /DMO/BOOKING23, /DMO/BOOK_SUP_23 you need to change the following types *
***********************************************************************************************************************************
...
**********************************************************************
  ...
  INCLUDE TYPE ts_travel_key.
  TYPES action_code TYPE /dmo/action_code23.
...
*********
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM action_code_enum STRUCTURE action_code BASE TYPE /dmo/action_code23,
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM travel_status_enum STRUCTURE travel_status BASE TYPE /dmo/travel_status23,
      initial   VALUE IS INITIAL,
      new       VALUE 'N',
      planned   VALUE 'P',
      booked    VALUE 'B',
...
************************
  ...
  INCLUDE TYPE ts_travel_key.
  INCLUDE TYPE /dmo/travel23_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id23.
  INCLUDE TYPE /dmo/booking23_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id23.
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id23.
  INCLUDE TYPE /dmo/book_sup_23_data.
